 ...
 * @version: $Id: MP3File.java,v 1.7 2002/01/27 03:22:48 helliker Exp $
 * Revsisions: 
 *  $Log: MP3File.java,v $
 *  Revision 1.7  2002/01/27 03:22:48  helliker
 *  Added methods to access additional MPEG data.
 *  Added methods to parse track data.
 *  Comparisons with compareTo uses pathnames now.
 *
 *  Revision 1.6  2002/01/24 01:12:48  helliker
 *  Avoids a divide by zero possibility.
 *
 *  Revision 1.5  2002/01/21 05:06:24  helliker
 *  Added support for VBR files.
 *
 *  Revision 1.4  2002/01/20 20:30:12  helliker
...
public class MP3File implements Comparable {
    ...
    /**
     * Returns an integer value of the track number.  If a track field of
     * an id3v2 tag has a '/' the number before the '/' will be returned.
     * Returns -1 if there is an error parsing the track field.
     *
    ...
    /**
     * Although not a standard, sometimes track numbers are expressed as 
     * "x/y" where x is the track number and y is the total number of tracks
     * on an album.  This method will attempt to return the y value.  Returns
     * -1 if there is an error parsing the field or if there is no id3v2 tag.
     *
    ...
    /**
     * Compare this MP3File to the specified object.  This comparson does
     * a simple compare of the two paths.  If the other object is not an
     * mp3, compareTo will always return a positive number.
     *
