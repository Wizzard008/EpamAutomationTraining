 ...
 * @version: $Id: Playlist.java,v 1.4 2002/01/27 03:21:03 helliker Exp $
 * Revsisions: 
 *  $Log: Playlist.java,v $
 *  Revision 1.4  2002/01/27 03:21:03  helliker
 *  Added the ability to read/write MusicMatch playlists.
 *  Sorts each time a directory is added instead of before written.
 *  Various optimizations.
 *
 *  Revision 1.3  2002/01/13 07:45:16  helliker
 *  Uses a StringBuffer in the toString method to speed up Playlist creation.
 *
...
package JavaCollections.MainTask.lib;
...
public class Playlist extends LinkedList {
    ...
    /**
     * Reads in mp3s from a directory and adds them to this playlist.  By
     * default, subdirectories will be recursed and the files will be sorted.
     *
     ...
     * subdirectories as well.  If the sort parameter is true the files
     * in each directory will be sorted before added.
     *
     * @param dir the directory to look for mp3s in
     ...
     * playlists.  The format parameter should be either WINAMP_FORMAT
     * or MUSICMATCH_FORMAT.
     *
     ...
     * @exception IOException if an error occurs
     */
    private void loadWinampFile( BufferedReader reader ) 
     ...
     * then the file will be created in that directory with the same name as 
     * the directory with a ".m3u" extension added.  If the destination is a 
     * file then the playlist will be saved to that file.  If the format
     * argument is invalid the file will not be written.
     *
