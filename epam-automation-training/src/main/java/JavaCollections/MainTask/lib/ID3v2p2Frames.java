 ...
 *
 * Description: 
 *  This class is a collection that is used to hold the ID3v2Frames.  This
 *  class is specificially designed for v2.2 tags.  
 *
...
public class ID3v2p2Frames extends HashMap {

    // Want to know what these fields store?  Go to www.id3.org
    public static String ALBUM = "TAL";
    public static String BPM = "TBP";
    public static String COMPOSER = "TCM";
    public static String CONTENT_TYPE = "TCO";
    public static String COPYRIGHT_MESSAGE = "TCR";
    //public static String ENCODING_TIME = "TDEN";
    public static String PLAYLIST_DELAY = "TDY";
    public static String ORIGINAL_RELEASE_TIME = "TOR";
