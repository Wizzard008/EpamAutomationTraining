 ...
 * @version: $Id: ID3v2Frames.java,v 1.3 2002/01/13 07:48:54 helliker Exp $
 * Revsisions: 
 *  $Log: ID3v2Frames.java,v $
 *  Revision 1.3  2002/01/13 07:48:54  helliker
 *  Ignore empty frames when calculating length and getting bytes
 *  to save space.
 *
