 ...
 * @version: $Id: ID3v2Footer.java,v 1.5 2002/01/25 05:29:34 helliker Exp $
 * Revsisions: 
 *  $Log: ID3v2Footer.java,v $
 *  Revision 1.5  2002/01/25 05:29:34  helliker
 *  Decodes/encodes length field as synchsafe int.
 *
 *  Revision 1.4  2001/12/04 04:57:10  helliker
 *  The getFooterSize always returns 10 to make calculations in id3v2Tag easier.
 *
